...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference("Estudiante.count") do
      post estudiantes_url, params: { estudiante: { Carnet: @estudiante.Carnet, apellido: @estudiante.apellido, celular: @estudiante.celular, fecha_de_nacimiento: @estudiante.fecha_de_nacimiento, nombre: @estudiante.nombre } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { Carnet: @estudiante.Carnet, apellido: @estudiante.apellido, celular: @estudiante.celular, fecha_de_nacimiento: @estudiante.fecha_de_nacimiento, nombre: @estudiante.nombre } }
